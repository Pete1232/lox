...
object Expression:
  ...
  given Show[Expression] = Show.show(
    _ match
  ...
  object Literal:
    given Show[Literal] = Show.show(_.value.toString)
  ...
  object Group:
    given showGroup: Show[Group] = Show.show { g =>
  ...
  object Ternary:
    given Show[Ternary] = Show.show { t =>
